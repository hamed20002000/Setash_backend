...
@Injectable()
export class SystemNotificationsRepository extends BaseRepository<SystemNotifications> {
  constructor(@InjectRepository(SystemNotifications) repository: Repository<SystemNotifications>) {
    super(repository);
  }
