...
@Injectable()
export class InvoiceHeaderStatusHistoriesRepository extends BaseRepository<InvoiceHeaderStatusHistories> {
  constructor(@InjectRepository(InvoiceHeaderStatusHistories) repository: Repository<InvoiceHeaderStatusHistories>) {
    super(repository);
  }
